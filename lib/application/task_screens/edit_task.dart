...
class EditTaskScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return taskFromFirestore.when(
      data: (taskFromFirestore) {
        if (taskFromFirestore == null) {
          return Scaffold(
        ...
        if (taskState == null || taskState.id != taskFromFirestore.id) {
          //TODO : change to edit elsewhere
          Future.microtask(() {
            taskController.setEditableTask(taskFromFirestore);
          });
          return Scaffold(
            appBar: AppBar(title: const Text('Edit Task')),
